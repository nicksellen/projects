...
The Constitutional layer contains the core agreements upon which the other layers are built. It is documented in the Constitution (this document) and outlines the roles people can adopt and how changes can be made at the different layers. Making changes at this layer takes the most time and energy and should thus occur at the slowest rate. 

The Collective-Choice layer contains more concrete and specific agreements than those at the Constitutional layer. It is documented in the [Collective-Choices](url.here) and could include things such as policies, schedules, facts or best-practices. Making changes at this layer takes a moderate amount of time and energy and should thus occur at a moderate rate.
...
1. In order to become a Volunteer, a person must— 
	...
	1. demonstrate they understand and accept the Constitution and Collective Choices.
1. A person becomes a Volunteer subject to a successful result from an Application Procedure where `the participants` means resident Members and Volunteers.
...
1. Unanimous Acceptance
	...
	1. There is no specific format for finding a proposal with Unanimous Acceptance. Many tool and techniques exist which may help, including: rounds, talking objects, consensus facilitation, socratic dialogue, etc, etc.
...
1. At the end of the secondary phase—
	...
	1. the proposal with the highest total is selected as the final decision, and 
	1. the Collective Choices should be changes to reflect this decision (if applicable.)
